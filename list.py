...
# accounts = []
# accounts.append(BankAccount("Sandesh", 5000))
# accounts.append(BankAccount("Ravi", 8000))
...
# players = ['sandesh', 5000]
# players = ['chaudhary', 2000]
# print(players)

# create 2 players and add to list
